         ...
         <div id="right-wrapper-config">
             ...
             <div id="right-wrapper-config-left">
                 ...
                 <form name="formvalues" id="formvalues" method="POST">
                         ...
                         <div class='pad-12'>
                             <div>
                                 ...
                                 <div class="float-left" title="<?php echo strIdx(63);?>">
                                     <div class="text-10">Notificatie bij het wegvallen van de P1 data.&nbsp;</div>
                                 </div>
                                 <!-- right side -->
                     ...
                     <div class="frame-4-top">
                         <span class="text-15">3 Fase</span>
                     </div>
                     <div class="frame-4-bot">
                         <div class='pad-12'>
                             <div>
                                 <!-- left side -->
                                 <div class="float-left" title="<?php echo strIdx(63);?>">
                                     <div class="text-10">Notificatie bij overschrijding van de min. of max. spanning
                                         (V).&nbsp;</div>
                                 </div>
                                 <!-- right side -->
                                 <div class="float-right">
                                     <div>
                                         <input class="cursor-pointer" id="fs_rb_v_max_on" name="fs_rb_v" type="radio"
                                             value="1" <?php if ( config_read( 175 ) == 1 ) { echo 'checked'; }?>>Aan
                                         <input class="cursor-pointer" id="fs_rb_v_max_off" name="fs_rb_v" type="radio"
                                             value="0" <?php if ( config_read( 175 ) == 0 ) { echo 'checked'; }?>>Uit
                                     </div>
                                     <p></p>
                                 </div>
                             </div>
