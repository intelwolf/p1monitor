...
<!-- historie dag gas -->
<title>P1monitor<?php echo strIdx(344)." ".strIdx(135)." ".strIdx(336);?></title>
            ...
            setExtremes: function(e) {
                if(typeof(e.rangeSelectorButton)!== 'undefined') {
                    ...
                    if ( GselectText[j] == e.rangeSelectorButton.text ) {
                        toLocalStorage('stat-d-select-gas-index',j+1); // #PARAMETER
                        break;
                    }
                    }
                }
...
$(function() {
    ...
    GseriesVisibilty[3] = JSON.parse(getLocalStorage('stat-d-gas-graaddagen-visible'));
...
<div class="mid-section">
    ...
    <!-- links -->
    	<div class="frame-2-top">
    		<span class="text-2"><?php echo strIdx(122);?> (m<sup>3</sup> <?php echo strIdx(336);?>)</span>
    	</div>
