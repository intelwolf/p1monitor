...
<!-- historie jaar gas -->
<title>P1monitor <?php echo strIdx(344)." ".strIdx(132)." ".strIdx(336);?></title>
...
var initloadtimer;
var Gselected       = 0;
var GselectText     = [ '5 '+text_year, '10 '+text_year, '15 '+text_year, '20 '+text_year ];    // #PARAMETER
                ...
                setExtremes: function(e) {
                    if(typeof(e.rangeSelectorButton)!== 'undefined') {
                        ...
                        if ( GselectText[j] == e.rangeSelectorButton.text ) {
                            toLocalStorage('stat-j-select-gas-index',j); // #PARAMETER
                            break;
                        }
                        }
                    }
        ...
        series: {
            ...
            events: {
                legendItemClick: function () {
                    ...
                    if ( this.index === 0 ) {
                    toLocalStorage('stat-j-gas-visible',!this.visible); // #PARAMETER
                    }
                    if ( this.index === 1 ) {
...
<div class="top-wrapper-2">
    <div class="content-wrapper pad-13">
       <!-- header 2 -->
       <?php pageclock(); ?>
       <?php page_menu_header_gas(2); ?> <!-- #PARAMETER -->
       <?php weather_info(); ?>
    </div>
</div>
...
<div class="mid-section">
    ...
    <!-- links -->
        <div class="frame-2-top">
            <span class="text-2"><?php echo strIdx(124);?> (m<sup>3</sup> <?php echo strIdx(336);?>)</span>
        </div>
