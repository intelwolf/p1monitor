...
<title>P1-monitor <?php echo strIdx( 423 )?></title>
                ...
                series :{
                    ...
                    events: {
                        legendItemClick: function (event) {
                            if  ( this.index === 0 ) {
                                toLocalStorage('stat-m-verbr-visible',!this.visible);  // #PARAMETER
                            }
                            if  ( this.index === 1 ) {
                                toLocalStorage('stat-m-gelvr-visible',!this.visible);  // #PARAMETER
                            }
                            if  ( this.index === 2 ) {
                                toLocalStorage('stat-m-netto-visible',!this.visible);  // #PARAMETER
                            }
                            if  ( this.index === 3 ) {
                                toLocalStorage('stat-m-temp-visible',!this.visible);  // #PARAMETER
                            }
                        }
                    }
                }
                    ...
                    if(typeof(e.rangeSelectorButton)!== 'undefined') {
                        for (var j = 0;  j < GselectText.length; j++){    
                            if ( GselectText[j] == e.rangeSelectorButton.text ) {
                                toLocalStorage('stat-m-select-index',j+1); // PARAMETER
                                break;
                            }
                        }
                    }
...
$(function() {
    ...
    Gselected = parseInt(getLocalStorage('stat-m-select-index'),10);
    GseriesVisibilty[0] =JSON.parse(getLocalStorage('stat-m-verbr-visible'));  // #PARAMETER
...
<div class="mid-section">
    ...
    <!-- links -->
    	<div class="frame-2-top">
    		<span class="text-2"><?php echo strIdx( 123 );?> (kWh)</span>
    	</div>
