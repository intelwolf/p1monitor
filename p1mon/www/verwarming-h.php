...
<title>P1-monitor <?php echo strIdx( 458 )?></title>
...
var GselectText     = ["12 "+text_hours ,"1 "+text_day,"1 "+text_week,"1 "+text_month] // #PARAMETER
...
function readJsonIndoorTemperatureHour( cnt ){ 
    $.getScript( "./api/v1/indoor/temperature/hour?limit=" + cnt , function( data, textStatus, jqxhr ) {
      try {
...
$(function() {
    ...
    GseriesVisibilty[0] = JSON.parse(getLocalStorage('verwarming-h-in-visible'));
    GseriesVisibilty[1] = JSON.parse(getLocalStorage('verwarming-h-in-gem-visible'));
...
<div class="top-wrapper-2">
    <div class="content-wrapper pad-13">
       <!-- header 2 -->
        <?php pageclock(); ?>
        <?php page_menu_header_heating(2); ?>  <!-- parameter -->
        <?php weather_info(); ?>
    </div>
</div>
...
<div class="mid-section">
    ...
    <!-- links -->
        <div class="frame-2-top">
            <span class="text-2"><?php echo strIdx( 459 );?></span>
        </div>
