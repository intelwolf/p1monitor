...
function readJsonApiHistoryPowerMonth( cnt ){ 
    $.getScript( "/api/v1/powerproduction/month?limit=" + cnt, function( data, textStatus, jqxhr ) {
        try {
                ...
                series :{
                    ...
                    events: {
                        legendItemClick: function (event) {
                            ...
                            if  ( this.index === 0 ) {
                                toLocalStorage('powerprod-m-high-tariff-visible',!this.visible);  // #PARAMETER
                            }
                            if  ( this.index === 1 ) {
                                toLocalStorage('powerprod-m-low-tariff-visible',!this.visible);  // #PARAMETER
                            }
                            if  ( this.index === 2 ) {
                                toLocalStorage('powerprod-m-netto-visible',!this.visible);  // #PARAMETER
                            }
                            if  ( this.index === 3 ) {
                                toLocalStorage('powerprod-m-temp-visible',!this.visible);  // #PARAMETER
                            }
                        }
                    }
                },
...
<div class="top-wrapper-2">
    <div class="content-wrapper pad-13">
       <!-- header 2 -->
       <?php pageclock(); ?>
       <?php page_menu_header_powerproduction( 3 ); ?>
       <?php weather_info(); ?>
    </div>
</div>
