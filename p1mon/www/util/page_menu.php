...
function page_menu($id) {
    ...
    if ( config_read(18) == 1 ) {
        echo "<a id=\"menu6\" href=\"e-verbruik.php\">
    ...
    if ( config_read(19) == 1 ) {
        echo "<a id=\"menu1\" href=\"stats.php\">
    ...
    if ( config_read( 129 ) == 1 ) {
        echo "<a id=\"menu11\" href=\"powerproduction-min.php\">
            <span class=\"fa-layers fa-gw frame-1-mid $m11\">
                <i class=\"fas fa-signal\" data-fa-transform=\"grow-18\"></i>
                <i class=\"fas fa-solar-panel\" data-fa-transform=\"grow-4 left-8 up-7\"></i>
                <i class=\"fas fa-bolt\" data-fa-transform=\"shrink-6 left-7 up-9\"></i>
            </span>
        </a>"."\n";
    }

    if ( config_read(20) == 1 ) {
        echo "<a id=\"menu5\" href=\"stats-h-gas.php\">
    ...
    if ( config_read( 102 ) == 1 ) {
        echo "    <a id=\"menu9\" href=\"watermeter-h.php\">
    ...
    // verwarming
    if ( config_read(46) == 1 ) { 
        echo "    <a id=\"menu7\" href=\"verwarming-a.php\">
    ...
    if ( config_read(21) == 1 ) {
        echo "    <a id=\"menu4\" href=\"kosten-d.php\">
    ...
    if ( config_read(62) == 1 ) {
        echo "    <a id=\"menu8\" href=\"meterreadings-d-kwh.php\">
    ...
    if ( config_read(61) == 1 ) {
        echo "  <a id=\"menu10\" href=\"fase-a.php\">
    ...
    if($localip == True or $noInetCheck == True){
        echo "    <a id=\"menu2\" href=\"config-tarief.php\">
