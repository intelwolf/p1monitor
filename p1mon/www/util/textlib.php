...
/* 002 */   array(
    'Omdat de slimme meter ongeveer elke 10 seconden de gegevens stuurt kan het tussen de 30 tot 60 seconden duren voordat de status correct wordt weergegeven.',
    'Because the smart meter sends the data approximately every 10 seconds, it can take between 30 to 60 seconds for the status to be displayed correctly',
    'Parce que le compteur intelligent envoie les données environ toutes les 10 secondes, il peut prendre entre 30 à 60 secondes pour l&apos;état à afficher correctement'
    ),
/* 003 */   array(
