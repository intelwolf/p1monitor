...
<title>P1-monitor <?php echo strIdx( 455 );?></title>
...
var GselectText     = ['15 '+text_min_short,'30 '+text_min_short,'1 '+text_hour ,'12 '+text_hours ,'24 '+text_hours ]; // #PARAMETER
...
var maxrecords      = 1441; // number of records to read
...
function DataLoop() {
    ...
    if(secs < 0 ) { 
        ...
        readJsonIndoorTemperatureMin( maxrecords );
    }
...
$(function() {
    ...
    GseriesVisibilty[0] = JSON.parse(getLocalStorage('verwarming-min-in-visible'));
    GseriesVisibilty[1] = JSON.parse(getLocalStorage('verwarming-min-in-gem-visible'));
    GseriesVisibilty[2] = JSON.parse(getLocalStorage('verwarming-min-uit-visible'));
    GseriesVisibilty[3] = JSON.parse(getLocalStorage('verwarming-min-uit-gem-visible'));
    Gselected = parseInt(getLocalStorage('verwarming-min-select-temperatuur-index'),10);
...
<div class="top-wrapper-2">
    <div class="content-wrapper pad-13">
       <!-- header 2 -->
        <?php pageclock(); ?>
        <?php page_menu_header_heating(1); ?>  <!-- parameter -->
        <?php weather_info(); ?>
    </div>
</div>
...
<div class="mid-section">
    ...
    <!-- links -->
        <div class="frame-2-top">
            <span class="text-2"><?php echo strIdx( 456 );?></span>
        </div>
