...
#
##############################################################
# python environment hoeft/mag niet gezet zijn in dit script #
##############################################################

echo "------------------------------"
echo "| Alleen voor ontwikkelwerk! |"
echo "------------------------------"
#/p1mon/p1monenv/bin/gunicorn --timeout 900 --bind localhost:10721 --worker-tmp-dir /p1mon/mnt/ramdisk --workers 1 P1Api:app 
