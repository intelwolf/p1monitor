...
# added/changed in version 2.4.3
time_date = api_time_lib.DateTime()
time_date.set_flog( flog )
app.add_route( apiconst.ROUTE_DATETIME, time_date )

time_date_help = api_time_lib.DateTimeHelp()
...
watermeter = api_water_lib.Watermeter()
watermeter.set_flog( flog )
watermeter.set_database( watermeter_db )
app.add_route( apiconst.ROUTE_WATERMETER_MIN_V2,   watermeter )
app.add_route( apiconst.ROUTE_WATERMETER_HOUR_V2,  watermeter  )
app.add_route( apiconst.ROUTE_WATERMETER_DAY_V2,   watermeter  )
app.add_route( apiconst.ROUTE_WATERMETER_MONTH_V2, watermeter  )
app.add_route( apiconst.ROUTE_WATERMETER_YEAR_V2,  watermeter  )

# Deprecated remove in future versions 
# added in version 3.3.0 
watermeter_help = api_water_lib.WaterHelp() 
watermeter_help.set_flog( flog )
app.add_route( apiconst.ROUTE_WATERMETER_MIN_HELP_V2,   watermeter_help )
app.add_route( apiconst.ROUTE_WATERMETER_HOUR_HELP_V2,  watermeter_help)
app.add_route( apiconst.ROUTE_WATERMETER_DAY_HELP_V2,   watermeter_help)
app.add_route( apiconst.ROUTE_WATERMETER_MONTH_HELP_V2, watermeter_help)
app.add_route( apiconst.ROUTE_WATERMETER_YEAR_HELP_V2,  watermeter_help )

# Digital watermeter API's
# added in version 3.3.0
watermeter_digital = api_water_lib.WatermeterDigital() #  
watermeter_digital.set_flog( flog )
watermeter_digital.set_database( watermeter_db )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_MIN,   watermeter_digital )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_HOUR,  watermeter_digital )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_DAY,   watermeter_digital )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_MONTH, watermeter_digital )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_YEAR,  watermeter_digital )


watermeter_digital_help = api_water_lib.WaterDigitalHelp() # added in version 3.3.0 
watermeter_digital_help.set_flog( flog )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_MIN_HELP,   watermeter_digital_help )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_HOUR_HELP,  watermeter_digital_help )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_DAY_HELP,   watermeter_digital_help )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_MONTH_HELP, watermeter_digital_help )
app.add_route( apiconst.ROUTE_WATERMETER_DIGITAL_YEAR_HELP,  watermeter_digital_help )
